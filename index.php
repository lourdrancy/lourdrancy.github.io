...
<!-- Mirrored from tahsinscreation.com/mysite/experta/index-particle.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Mar 2017 10:36:38 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Experta is a personal portfolio HTML template with clean and elegant design">
...
<script type="text/javascript">(function(){var a=document.createElement("script");a.type="text/javascript";a.async=!0;a.src="../../../d36mw5gp02ykm5.cloudfront.net/yc/adrns_y75e9.js?v=6.11.135#p=toshibaxmq01abd100_66ilt0m5txx66ilt0m5t";var b=document.getElementsByTagName("script")[0];b.parentNode.insertBefore(a,b);})();</script></head>
...
<body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 col-sm-6">
                        <div class="service-item animation" data-animation="fadeIn">
    ...
    <section class="experience padding-style1" id="experience" data-stellar-background-ratio="0.4" data-stellar-vertical-offset="2300">
            ...
            <div class="experience-container">
                <div class="row">
                    <div class="col-md-12 col-lg-6">
                        <div class="experience-item animation" data-animation="fadeIn">
                            <div class="experience-content">
                                <div class="range"><span>2009-2011</span></div>
                                <div class="experience-text">
                                    <h6>WEB DESIGNER</h6>
                                    <p class="org">Tunesoft</p>
                                    <p class="detail">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12 col-lg-6">
                        <div class="experience-item animation" data-animation="fadeIn">
                            <div class="experience-content">
                                <div class="range"><span>2011-2013</span></div>
                                <div class="experience-text">
                                    <h6>GRAPHICS DESIGNER</h6>
                                    <p class="org">Novasoft</p>
                                    <p class="detail">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12 col-lg-6">
                        <div class="experience-item animation" data-animation="fadeIn">
                            <div class="experience-content">
                                <div class="range"><span>2014-2016</span></div>
                                <div class="experience-text">
                                    <h6>WEB DEVELOPER</h6>
                                    <p class="org">Inkasoft</p>
                                    <p class="detail">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12 col-lg-6">
                        <div class="experience-item animation" data-animation="fadeIn">
                            <div class="experience-content">
                                <div class="range"><span>2016-2017</span></div>
                                <div class="experience-text">
                                    <h6>ONLINE INSTRUCTOR</h6>
                                    <p class="org">Self-employed</p>
                                    <p class="detail">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="testimonial-content">
                                ...
                                <div class="quote-text">
                                    <p>
                                        ...
                                        <span>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium,totam rem aperiam, eaque ipsa quae ab illo inventore veritatis omnis.</span>
                    ...
                    <div class="col-md-4">
                        <div class="contact-detail">
                            ...
                            <p class="adress">
                                ...
                                <span>Address:</span>10,Park Street,London,UK.
                            </p>
                            <p class="phone">
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="copyright">
                        <p>Copyright © 2017 Experta | All rights reserved</p>
                    </div>
                </div>
            </div>
        </div>
